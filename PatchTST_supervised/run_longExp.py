...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss', type=str, default='mse',
                        help='loss function options: [mse, time_huber, vahuber, fredf_pca, fredf_pca_learnable, fredf_fft, fredf_fft_learnable]')
    ...
    parser.add_argument('--huber_delta', type=float, default=1.0, help='delta for time-domain Huber loss')
    parser.add_argument('--freq_basis_path', type=str, default='', help='path to FreDF-PCA basis for LFT loss and initialization')
