...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
        ...
        # Keep a handle to the trained criterion so diagnostics in `test` can
        # reuse the learned transform parameters.
        self._trained_criterion = criterion
    ...
    def test(self, setting, test=0):
        ...
        self._log_basis_delta(getattr(self, '_trained_criterion', None), 'test')
